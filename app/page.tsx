...
export default function Home() {
  ...
  async function generateWithAPI() {
    ...
    if (!propertyDescription) {
      showStatus('Please fill in Property Description', 'error');
      return;
    }
    if (!parcelNumber) {
      showStatus('Please fill in Parcel Number', 'error');
      return;
    }
    if (!acreage) {
      showStatus('Please fill in Acreage', 'error');
      return;
    }
    if (!district) {
      showStatus('Please fill in District', 'error');
      return;
    }
    if (!county) {
      showStatus('Please fill in County', 'error');
      return;
    }
